...
<header id="navLinks" class="primary-navigation flex font-sen font-regular fixed z-30 right-[1.67vw] top-1" class:open={isNavOpen}>
    ...
    <a href="#contact" class="hover-underline-animation  font-regular text-[14px] center m-[16px] text-[#FFFFFF] custom-selection" onclick={closeNav}><span aria-hidden="true" class="custom-selection">Contact</span></a>
</header>
